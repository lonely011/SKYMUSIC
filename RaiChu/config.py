...
ALIVE_NAME = getenv("ALIVE_NAME", "SKY MUSIC")
ASSISTANT_USERNAME = getenv("ASSISTANT_USERNAME", "YurikoPlugin")
BOT_USERNAME = getenv("BOT_USERNAME")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "assist")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/lonely011/SKYMUSIC")
